module.exports = (function(){
    ...
    function getEnrolledInCareMOh(params, callback) {
        ...
        eClient.search(query).then(function(data) {
            ...
            console.log('getEnrolledInCareMOh: below 15 (female) query: ', 
            ...
            eClient.search(query).then(function(data) {
                ...
                eClient.search(query).then(function(data) {
                    ...
                    query = careQueries.enrolledInCareQuery(params);
                    console.log('getEnrolledInCareMOh: 15 and above (Male) query: ', JSON.stringify(query));
                    eClient.search(query).then(function(data) {
                        ...
                        params.gender = 'F';
                        query = careQueries.enrolledInCareQuery(params);
                        console.log('getEnrolledInCareMOh: 15 and above (Female) query: ', JSON.stringify(query));
                        eClient.search(query).then(function(data) {
                            var above15Female = data.aggregations.enrolled.buckets.length;
                            var total = below15Male + below15Female + above15Female + above15Male;
                            var response = {
    ...
    function getActiveInCareMoh(params, callback, eCallback) {
        ...
        eClient.search(query).then(function(data) {
            ...
            var below1;
            _getActiveInCarePatientsCount(params, below1Patients, function(data) {
                below1 = data;
            ...
            console.log('getActiveInCareMoh: below 15 (female) query: ', 
                            JSON.stringify(query));
            eClient.search(query).then(function(data) {
                var buckets = data.aggregations.active.patients.buckets;
                ...
                //Get the transferOut
                var below15Male;
                _getActiveInCarePatientsCount(params, below15Patients, function(data) {
                    below15Male = data;
                ...
                eClient.search(query).then(function(data) {
                    ...
                    //eliminate transfer out
                    var below15Female;
                    _getActiveInCarePatientsCount(params, below15FemalePatients, function(data) {
                        below15Female = data;
                    ...
                    console.log('params: ',params, 'params object', params);
                    query = careQueries.activeInCareQuery(params);
                    console.log('getActiveInCareMoh: 15 and above (Male) query: ', JSON.stringify(query));
                    eClient.search(query).then(function(data) {
                        var buckets = data.aggregations.active.patients.buckets;
                        ...
                        var above15Male;
                        _getActiveInCarePatientsCount(params, above15MalePatients, function(data) {
                            above15Male = data;
                        ...
                        params.gender = 'F';
                        query = careQueries.activeInCareQuery(params);
                        console.log('getActiveInCareMoh: 15 and above (Female) query: ', JSON.stringify(query));
                        eClient.search(query).then(function(data) {
                            var buckets = data.aggregations.active.patients.buckets;
                            ...
                            // Eliminate transfer outs
                            var above15Female;
                            _getActiveInCarePatientsCount(params, above15FemalePatients, function(data) {
                                above15Female = data;
                                
                                console.log('below15Male: ',below15Male, ', below15Female: ', below15Female,
                                ', above15Female: ', above15Female, 'above15Male:', above15Male);
                                var total = below15Male + below15Female + above15Female + above15Male;
                                var response = {
    ...
    function _getActiveInCarePatientsCount(params, patientsCount, callback, message) {
        var q = careQueries.transferOutQuery(params);
